...
| `docs/features/audio-metadata.md` | New — audio metadata extraction feature spec (replaces the image/PDF metadata-extraction.md from the original starter; see `2026-05-21-initial-scaffold.md`) |
...
9. Create `docs/features/audio-metadata.md` (replaces image/PDF `metadata-extraction.md`; backed by `services/api/app/service/audio_metadata.py` after the audio-starter-kit refit)
