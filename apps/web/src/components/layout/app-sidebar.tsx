...
const navItems = [
  ...
  { title: "Go live", href: "/live", icon: Radio },
    ...
    <Sidebar>
      <SidebarHeader className="border-b border-sidebar-border px-4 py-3.5">
        ...
        >
          ...
          <span>GPT-Realtime-Translate Live Event Interpreter</span>
        </Link>
      </SidebarHeader>
      ...
      <SidebarFooter className="border-t border-sidebar-border px-4 py-3">
        <a
          href="https://www.backblaze.com/cloud-storage?utm_source=github&utm_medium=referral&utm_campaign=ai_artifacts&utm_content=b2ai-gpt-realtime-translate-live-event-interpreter"
          target="_blank"
